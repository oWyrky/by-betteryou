...
CREATE TABLE public.profiles (
  ...
  water_increment_ml INT NOT NULL DEFAULT 100,
...
-- Create daily habits tracking table
CREATE TABLE public.daily_habits (
  ...
  exercise_justified BOOLEAN NOT NULL DEFAULT false,
...
CREATE TRIGGER update_daily_habits_updated_at BEFORE UPDATE ON public.daily_habits FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
